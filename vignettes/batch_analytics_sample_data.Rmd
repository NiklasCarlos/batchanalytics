...
#maybe rename status - arrival
test <- df_logConc %>% gather(status, timestamp, arrival, start, complete)


# check order value of table elogs------


#order is wrong see data and ordering col is wrong
