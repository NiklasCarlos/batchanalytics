    ...
    sidebarLayout(
        sidebarPanel(
            ...
            selectInput("funcTable", "Choose function:",
                        choices= c("show_summary",   "metric_batch_size","metric_batch_frequency" ,"metric_waiting_times", "cycle_time_efficiency"  )),
            ...
            selectInput("funcPlot", "Choose function for ploting:",
                        choices= c("compare_throughput_time", "compare_processing_time" , "compare_idle_time", "compare_processing_time_of_activites", "compare_throughput_time_of_activites" )),
